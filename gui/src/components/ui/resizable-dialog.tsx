      ...
      <ResizableDialogPortal data-slot="resizable-dialog-portal">
        ...
        >
          ...
          >
            <div
              className={cn(
                'bg-[var(--background)] flex flex-col h-full w-full rounded-lg border shadow-lg overflow-hidden',
                className
              )}
            >
              {children}
...
function ResizableDialogBody({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
